  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
        ...
        >
          <Card className="relative overflow-hidden border-2 border-primary/50 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full rounded-2xl">
        ...
        >
          <Card className="border border-border shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-300 h-full rounded-2xl">
            <CardContent className="p-8 flex flex-col h-full items-center text-center">
