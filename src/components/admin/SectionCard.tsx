...
import { TopicMultiSelect } from "../ui/topic-multi-select";
...
const SectionCard = ({ sectionId, sectionName, questionCount, attemptLimit, durationMinutes, sectionDifficulty, sectionTopics, defaultMarkingScheme, markingScheme, onEdit, onRemove }: SectionCardProps
) => {
